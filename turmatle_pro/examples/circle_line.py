...
def main():
    ...
    circle1 = Circle(
        ...
        tangent_angle=120,           # 切点所在角度
        tangent_length=1,        # 切线半长（数学坐标），None 表示自动
    ...
    # 保存图像
    ps_path = os.path.join(IMG_DIR, 'circle_line.ps')
    png_path = os.path.join(IMG_DIR, 'circle_line.png')
